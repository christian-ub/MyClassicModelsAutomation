*** Settings ***
Documentation   SQL scripts for TC_04_02: Count of sales all offices
...
Set Variables    # Manual insert of TestCase and Test_Columns
    set test variable    ${TestCase}    TC_04_02
    set test variable    ${Test_Column_1}    Count_All_Office_Sales
    set test variable    ${TestStatus}    Pending

Count of sales all offices    # Manual insert of SQL query and handling of variables
    Log    ${TestStatus}
    ${QueryResults} =  Row count    SELECT orderNumber FROM orders
    Set Suite Variable    ${TestValue_Column_1}  ${QueryResults}
