*** Settings ***
Documentation   SQL scripts for TC_04_01: Sum of sales all offices
...
Set Variables    # Manual insert of TestCase and Test_Columns
    set test variable    ${TestCase}    TC_04_01
    set test variable    ${Test_Column_1}    Sum_All_Office_Sales
    set test variable    ${TestStatus}    'Pending'

Sum of sales all offices    # Manual insert of SQL query and handling of variables
    Log    ${TestStatus}
    ${QueryResults} =  Query  SELECT sum(amount) FROM payments
    Set Suite Variable  ${TestValue_Column_1}  ${QueryResults[0][0]}
